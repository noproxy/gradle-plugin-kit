...
public class PropertyPromotingLoggerFactory {
    ...
    private final List<String> QUIET_VALUES = Arrays.asList("true", "max", "all", "yes", "y");
    private final List<String> NO_PROMOTING_VALUES = Arrays.asList("false", "min", "none", "no", "n");
